...
<body>
	<form id="inputForm" action="${ctx}/register" method="post" class="form-horizontal">
		<fieldset>
			...
			<div class="control-group">
				<label for="loginName" class="control-label">QQ号码:</label>
				<div class="controls">
					<input type="text" id="qqNumber" name="qqNumber" class="input-large required" minlength="3"/>
				</div>
			</div>
			
			<div class="control-group">
				<label for="loginName" class="control-label">手机号码:</label>
				<div class="controls">
			...
			<div class="control-group">
				<label for="loginName" class="control-label">email:</label>
				<div class="controls">
			...
			<div class="control-group">
				<label for="loginName" class="control-label">支付宝账号:</label>
				<div class="controls">
					<input type="text" id="aliPay" name="aliPay" minlength="3"/>
				</div>
			</div>
