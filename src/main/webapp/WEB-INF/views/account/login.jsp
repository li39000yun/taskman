...
<body>
	...
	%>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="password" id="password" name="password" value="admin" class="input-medium required"/>
			</div>
		</div>
		...
		<div class="control-group">
			<div class="controls">
				...
				<input id="submit_btn" class="btn btn-primary" type="submit" value="登录"/> <a class="btn" href="${ctx}/register">注册</a>
			 	<span class="help-block"><a href="${ctx}/static/html/agreement.html"> <b>有偿开发协议</b></a>, <a href="${ctx}/static/html/framework.html"> <b>框架说明</b></a></span>
			</div>
		</div>
	</form>
